...
// Export list of route names

var routeList = exports.routeList = routes.map(function (route) {
  return route.path;
});
...
Component.options.__file = "/Users/jack/Projects/rethinq/rethinq.io/src/App.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-37940d64", Component.options)
  } else {
    hotAPI.reload("data-v-37940d64", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-37940d64", module.exports)
  }
}
